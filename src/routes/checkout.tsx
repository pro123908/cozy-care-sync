  ...
  const placeOrder = async (data: PlacedOrderData) => {
    ...
    try {
      ...
      const body = {
        ...
        // Pass click/browser IDs for Meta CAPI attribution, plus our own
        // stable visitor id for the admin-side "unique visits" count
        meta: { ...getMetaBrowserIds(), visitor_id: getOrCreateVisitorId() },
      };
